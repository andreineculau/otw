...
(function() {
  ...
  describe('AcceptHeader', function() {
    it('should parse a simple media-types correctly', function() {
      var h;
    ...
    it('should parse custom media-types with parameters correctly', function() {
      var h;
      h = new AcceptHeader('application/vnd.custom-v1+json ;test=true; 123=qwe, application/vnd.custom-v1+xml;test=false;456=qwe');
      return h.tokens.should.eql([
        {
          mediaType: 'application/vnd.custom-v1+json',
          syntax: 'json',
          test: 'true',
          123: 'qwe'
        }, {
          mediaType: 'application/vnd.custom-v1+xml',
          syntax: 'xml',
          test: 'false',
          456: 'qwe'
        }
    ...
    it('should parse complex media-types with parameters correctly', function() {
      var h;
    ...
    return it('should be able to stringify correctly', function() {
      var h;
      h = new AcceptHeader('application/vnd.custom-v1+json;test=true;123=qwe,application/vnd.custom-v1+xml;test=false;456=qwe');
      return h.toString().should.equal('application/vnd.custom-v1+json;123=qwe;test=true,application/vnd.custom-v1+xml;456=qwe;test=false');
    });
  });
